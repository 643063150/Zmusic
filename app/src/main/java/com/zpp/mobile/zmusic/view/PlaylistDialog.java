...
import com.zpp.mobile.zmusic.utils.ItemDragCallback;
...
public class PlaylistDialog extends BottomDialog {
    ...
    public void onAttach(@NonNull Context context) {
        ...
        PlayerUtil.initPlayerViewModel(context, mPlayerViewModel, MyMusicService.class);
    }
    ...
    protected void onInitDialog(AppCompatDialog dialog) {
        ...
        assert context != null;
        mScrollToPositionHelper = new ScrollToPositionHelper(rvPlaylist, context.getResources().getColor(R.color.purple_200));
    ...
    private static class PlaylistAdapter extends RecyclerView.Adapter<PlaylistAdapter.ViewHolder> {
        ...
        private static class ViewHolder extends RecyclerView.ViewHolder implements SelectableHelper.Selectable,
            ...
            public ViewHolder(@NonNull View itemView, boolean emptyView) {
                ...
                mColorMark = res.getColor(R.color.purple_200);
                mColorTitle = res.getColor(R.color.black);
                mColorArtist = res.getColor(R.color.grey_500);
            }
