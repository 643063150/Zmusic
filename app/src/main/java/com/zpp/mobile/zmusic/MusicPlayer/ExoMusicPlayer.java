package com.zpp.mobile.zmusic.MusicPlayer;
 ...
 * @ClassName: ExoMusicPlayer
 * @Description:
 * @Author: zpp
 * @CreateDate: 2023/3/14 17:37
 * @UpdateUser:
 * @UpdateDate: 2023/3/14 17:37
 * @UpdateRemark:
 */
public class ExoMusicPlayer extends AbstractMusicPlayer {
    ...
    public ExoMusicPlayer(@NonNull Context context, @NonNull MediaSource.Factory mediaSourceFactory, @NonNull Uri uri) {
        ...
        mExoPlayer.setMediaItem(MediaItem.fromUri(uri.toString()));
    }
    ...
    public ExoMusicPlayer(@NonNull Context context, @NonNull Uri uri) {
        this(context, MediaItem.fromUri(uri.toString()));
    }
